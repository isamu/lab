...
test("separates code from comments and keeps line numbers", () => {
...
test("the contents of a string literal are not code", () => {
...
test("a multi-line block comment does not shift line numbers", () => {
  const view = viewOf(["/*", " * prose about @ts-ignore", " */", "const a = 1;"]);
